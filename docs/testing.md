...
extra hosts, service hostnames, ordered service capability additions and drops, ordered mixed service devices, raw identities, service-level PID limits, service shared-memory sizes, service memory limits, service-level temporary filesystems, service sysctls, restart and image pull policies, independent stop signals and raw
